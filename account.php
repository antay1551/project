            ...
            <div id="articles">
                <form action="php/UserController.php" class="form" method="post">
                    <div class="form__field">
                        ...
                        <input type="text" name="name" value="<?php print($user->get_name()); ?>" placeholder="Имя*"
                               required/>
                    </div>
                    <div class="form__field">
                        <label for="email">Your email</label>
                        <input type="email" name="email" value="<?php print($user->get_email()); ?>"
                               placeholder="E-Mail"/>
                    </div>
                    <div class="form__field">
                        <label for="phone">Your phone</label>
                        <input type="phone" name="phone" placeholder="Телефон"
                               value="<?php print($user->get_phone()); ?>" minlength="10" maxlength="15"/>
                    </div>
                    <div class="form__field">
                        <label for="password">Your password</label>
                        <input type="password" name="password" value="<?php print($user->get_password()); ?>"
